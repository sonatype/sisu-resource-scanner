        ...
        return new CompositeListenerExceptionPolicy()
        {
            ...
            public void onBegin( Listener listener, Exception e )
            {
                throw new RuntimeException( String.format(
                    "Listener [%s] failed to execute on begining of processing with exception [%s]", listener,
                    e.getMessage() ), e );
            }
            ...
            {
                throw new RuntimeException( String.format(
                    "Listener [%s] failed to execute on file [%s] with exception [%s]", listener,
            ...
            {
                throw new RuntimeException( String.format(
                    "Listener [%s] failed to execute on ending of processing with exception [%s]", listener,
                    e.getMessage() ), e );
            }
        };
    }
